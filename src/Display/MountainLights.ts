...
// 			let wispColor = rgbToHex(ok[i].color[0], ok[i].color[1], ok[i].color[2]);
// 			let thisColor = mixColors('#bde2eb', wispColor, 1 - (ok[i].position[1] / 500));
// 			if (i > 0) {
// 				gradString += ', ';
// 			}
// 			gradString += `${thisColor} ${(ok[i].position[0] / 500) * 100}%`;
// 		}
